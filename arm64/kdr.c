...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /Users/govindrnair/TheoNeuroLab/GridCellsCond/mod/kdr.mod\n");
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 95 in file geneval_cvode.inc:\n\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/govindrnair/TheoNeuroLab/GridCellsCond/mod/kdr.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  ...
  ":::realpath /Users/govindrnair/TheoNeuroLab/GridCellsCond/mod/geneval_cvode.inc\n"
